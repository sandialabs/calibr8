...
//! \file linear_thermoviscoelastic_plastic.hpp
//! \brief The interface for linear thermoviscoelastic-plastic local residual
...
template <typename T>
class LTVEPlastic : public LocalResidual<T> {
  public:
    LTVEPlastic(ParameterList const& inputs, int ndims);
    ~LTVEPlastic();
    void init_params();
