...
template <>
int HyperJ2PlaneStrain<double>::solve_nonlinear(RCP<GlobalResidual<double>>, int step) {
  return 0;
}

template <>
int HyperJ2PlaneStrain<FADT>::solve_nonlinear(RCP<GlobalResidual<FADT>> global, int step) {
