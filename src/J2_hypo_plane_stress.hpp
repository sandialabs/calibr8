...
//! \file J2HypoPlaneStress.hpp
//! \brief The interface for hypoelastic J2HypoPlaneStress local plasticity residuals

#include "local_residual.hpp"

namespace calibr8 {

//! \brief The local residual for J2HypoPlaneStress plasticity models
//! \tparam T The underlying scalar type used for evaluations
//! \details This implements a concrete instance of the LocalResidual
//! base class for a J2HypoPlaneStress plasticity model
template <typename T>
class J2HypoPlaneStress : public LocalResidual<T> {

  public:

    //! \brief The J2HypoPlaneStress constructor
    //! \param inputs The local residual parameterlist
    //! \param ndims The number of spatial dimensions
    J2HypoPlaneStress(ParameterList const& inputs, int ndims);

    //! \brief The J2HypoPlaneStress destructor
    ~J2HypoPlaneStress();
