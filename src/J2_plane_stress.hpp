...
//! \brief The interface for J2_plane_stress local plasticity residuals
...
template <typename T>
class J2_plane_stress : public LocalResidual<T> {

  public:

    //! \brief The J2_plane_stress constructor
    //! \param inputs The local residual parameterlist
    //! \param ndims The number of spatial dimensions
    J2_plane_stress(ParameterList const& inputs, int ndims);

    //! \brief The J2_plane_stress destructor
    ~J2_plane_stress();
