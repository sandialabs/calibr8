...
template <>
int HypoHillPlaneStrain<double>::solve_nonlinear(RCP<GlobalResidual<double>>, int step) {
  return 0;
}

template <>
int HypoHillPlaneStrain<FADT>::solve_nonlinear(RCP<GlobalResidual<FADT>> global, int step) {
